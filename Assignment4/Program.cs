...
{
    Title = "Assignment 4 Library Management System Web API With Clean Architecture",
    Version = "v1",
    Description = "Assignment 4 Library Management System Web API With Clean Architecture",
...
if (app.Environment.IsDevelopment())
{
    ...
    app.UseSwaggerUI(c =>
    {
        ...
        c.SwaggerEndpoint("/swagger/v1/swagger.json", "Assignment 4 Library Management System Web API With Clean Architecture v1");
    });
